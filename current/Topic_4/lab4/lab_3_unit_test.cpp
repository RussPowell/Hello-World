...
TEST_CASE("Building a Tree") {
  ...
  SECTION("Insert() Stress Test") {
    CHECK(tree.Insert(19) == true);
    CHECK(tree.Insert(1) == true);
    CHECK(tree.Insert(6) == true);
    CHECK(tree.Insert(8) == true);
    CHECK(tree.Insert(1) == false);
    CHECK(tree.Insert(11) == true);
    CHECK(tree.Insert(4) == true);
    CHECK(tree.Insert(19) == false);
    CHECK(tree.Insert(8) == false);
    CHECK(tree.Insert(5) == true);
    CHECK(tree.Insert(11) == false);
    CHECK(tree.Insert(4) == false);
    CHECK(tree.size() == 7 );
    CHECK(tree.InOrder() == "1 4 5 6 8 11 19 ");
  }
}
   */